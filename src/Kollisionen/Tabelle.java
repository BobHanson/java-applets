...
class Tabelle extends Panel {
    ...
    public void zeichneTabelle(Graphics g) {
    ...
    public void maleFelder(int anzahl, Graphics g) { // malt die komplette Tabelle
    ...
    public void maleSaeule(int[] hoehe, int feld, int dskey, Graphics g) { 
...
// Nachfolgende Methode malt die S�ulen einschl. Bezifferung.
    ...
    public void maleAufbauSaeule(int[] hoehe, int feld, int dskey, Graphics g) {

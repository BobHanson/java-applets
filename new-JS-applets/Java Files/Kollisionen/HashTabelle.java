...
public class HashTabelle extends Hashtable {
    ...
    HashTabelle() {
	// Bei Bedarf wird auf Klasse java.util.Hashtable zugegriffen. g
	...
	// falls gew�nscht, mu� number im Konstruktor inst. worden sein.
    ...
    public void NeueSaeule(int feldeintrag) { // S�ulenindex wird aufdatiert
	...
	// nat�rlich nur mit Integer-Eingaben m�glich. Daher nicht klassisch.
